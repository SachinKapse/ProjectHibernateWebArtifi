...
/>
    ...
    <!-- Scroll Reveal -->
    <script src="assets/css/scrollreveal.min.js"></script>
                        ...
                        <div class="swiper mySwiper">
                                <div class="swiper-wrapper">
                                     ...
                                     <a href="signup"> <button  class="button">SignUp</button></a>
                                        ...
                                        <div class="swiper-slide">
                                                <img src="assets/img/home/c2.jpg" alt="" class="home-img">
                                        ...
                                        <div class="swiper-slide">
                                                <img src="assets/img/home/c3.jpg" alt="" class="home-img">
                ...
                <div class="about-content container">
                        <div class="about-imageContent">
                                ...
                                <div class="aboutImg-textBox">
                                        ...
                                        <p class="content-description">Programming is the art of telling another human being what one wants the computer to do.</p>
                                </div>
                        </div>

                        <div class="about-details">
                                <div class="about-text">
                                        <h4 class="content-subtitle"><i>Software Training Center and Consultancy</i></h4>
                                        <h2 class="content-title">Our results reflect the passion, <br>hardwork and efforts of our students and teachers.</h2>
                                        <p class="content-description">Our goal is to improve the skill of student and make their future more bright and develope them to achieve their goal.</p>

                                        <ul class="about-lists flex">
                                                <li class="about-list">Java</li>
                                                <li class="about-list dot">.</li>
                                                <li class="about-list">Python</li>
                                                <li class="about-list dot">.</li>
                                                <li class="about-list">& more</li>
                                        </ul>
                                </div>
            ...
            <div class="menu-container container">
                    <div class="meu-text">
                            ...
                            <p class="section-description">
                                We dont make fake promise, We provides best teaching experience with best placements to students, Also students needs to give their best.
                            </p>
                    </div>
                    ...
                    <div class="menu-content">
                            <div class="menu-items">
                                    <div class="menu-item flex">
											...
											<svg class="menu-img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(51, 51, 51, 1);transform: ;msFilter:;"><path d="M20 6h-3V4c0-1.103-.897-2-2-2H9c-1.103 0-2 .897-2 2v2H4c-1.103 0-2 .897-2 2v11c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V8c0-1.103-.897-2-2-2zm-5-2v2H9V4h6zM4 8h16v4h-3v-2h-2v2H9v-2H7v2H4V8zm0 11v-5h3v2h2v-2h6v2h2v-2h3.001v5H4z"></path></svg>
                                            <div class="menuItem-details">
                                                    <h4 class="menuItem-topic">Mock Interview</h4>
                                                    <p class="menuItem-des">We arrange mock interviews to make more practice of students</p>
                                            </div>
                                    ...
                                    <div class="menu-item flex">
                                            <!-- <img src="images/menuImg1.png" alt="" class="menu-img"> -->
										    <svg class="menu-img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M13 6h2v11h-2zm4-3h2v14h-2zM9 9h2v8H9zM4 19h16v2H4zm1-7h2v5H5z"></path></svg>
                                            <div class="menuItem-details">
                                                    <h4 class="menuItem-topic">Practice on Machine Test</h4>
                                                    <p class="menuItem-des">We provide machine test to make strong practical base.</p>
                                            </div>
                                    ...
                                    <div class="menu-item flex">
                                            <!-- <img src="images/menuImg1.png" alt="" class="menu-img"> -->
											<svg class="menu-img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M20 17V7c0-2.168-3.663-4-8-4S4 4.832 4 7v10c0 2.168 3.663 4 8 4s8-1.832 8-4zM12 5c3.691 0 5.931 1.507 6 1.994C17.931 7.493 15.691 9 12 9S6.069 7.493 6 7.006C6.069 6.507 8.309 5 12 5zM6 9.607C7.479 10.454 9.637 11 12 11s4.521-.546 6-1.393v2.387c-.069.499-2.309 2.006-6 2.006s-5.931-1.507-6-2V9.607zM6 17v-2.393C7.479 15.454 9.637 16 12 16s4.521-.546 6-1.393v2.387c-.069.499-2.309 2.006-6 2.006s-5.931-1.507-6-2z"></path></svg>
                                            <div class="menuItem-details">
                                                    <h4 class="menuItem-topic">Database MYSQL</h4>
                                                    <p class="menuItem-des">For development we teach most traditional database which is MYSQL.</p>
                                            </div>
                            ...
                            <div class="menu-items">
                                    ...
                                    <!-- <ul class="time-lists">
                                            <img src="assets/img/home/service.svg" alt="" class="">
                                    </ul> -->
                                     <div class="menu-item flex">
                                            <!-- <img src="images/menuImg1.png" alt="" class="menu-img"> -->
                                            ...
                                            <div class="menuItem-details">
                                                    <h4 class="menuItem-topic">15+ Online Test</h4>
                                                    <p class="menuItem-des">In every batch we arrange online test.</p>
                                            </div>
                                    ...
                                    <div class="menu-item flex">
                                           <!--  <img src="images/menuImg1.png" alt="" class="menu-img"> -->
										     <svg class="menu-img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M21 5c0-1.103-.897-2-2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2V5zM5 19V5h14l.002 14H5z"></path><path d="M7 7h1.998v2H7zm4 0h6v2h-6zm-4 4h1.998v2H7zm4 0h6v2h-6zm-4 4h1.998v2H7zm4 0h6v2h-6z"></path></svg>
                                            <div class="menuItem-details">
                                                    <h4 class="menuItem-topic">Interview Preparation</h4>
                                                    <p class="menuItem-des">We prepare student for interview with mock interview.</p>
                                            </div>
                                    ...
                                    <div class="menu-item flex">
                                          <!--   <img src="images/menuImg1.png" alt="" class="menu-img"> -->
                                            ...
                                            <div class="menuItem-details">
                                                    <h4 class="menuItem-topic">Online Assignment submission on random problem</h4>
                                                    <p class="menuItem-des">For improving practice we provide online aasignment on random problem.</p>
                                            </div>
        ...
        <section class="section review" id="review">
            <div class="review-container container">
                    <div class="review-text">
                            ...
                            <p class="section-description">Here is review of some students who learned from us and became successfull in their life.</p>
                    </div>
                    ...
                    <div class="tesitmonial swiper mySwiper">
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="testi-content swiper-slide flex">
                                            <img src="assets/img/testimonials/testimonials-2.jpg" alt="" class="review-img">
                                            <p class="review-quote"> The best thing about H. S. group is that, they understand student issue and they handle the student with proper technique so that student feels comfertable</p>
                                            <i class='bx bxs-quote-alt-left quote-icon'></i>

                                            <div class="testi-personDetails flex">
                                                    <span class="name">Rahul Singh Parihar</span>
                                                    <span class="job">MRRSoft, Nagpur</span>
                                            </div>
                                    </div>
                                    <div class="testi-content swiper-slide flex">
                                            <img src="assets/img/testimonials/testimonials-3.jpg" alt="" class="review-img">
                                            <p class="review-quote">I really appriciate the hardwork that our menors take to develope us, They provide very friendly enviornment so that we can easily focus on study.</p>
                                            <i class='bx bxs-quote-alt-left quote-icon'></i>

                                            <div class="testi-personDetails flex">
                                                    <span class="name">Pooja Itankar</span>
                                                    <span class="job">Virtual Galaxy, Nagpur</span>
                                            </div>
                                    </div>
                                     <div class="testi-content swiper-slide flex">
                                            <img src="assets/img/testimonials/testimonials-4.jpg" alt="" class="review-img">
                                            <p class="review-quote"> They are really prooving that they dont make fake promises. They develope student from root and make their future more bright.</p>
                                            <i class='bx bxs-quote-alt-left quote-icon'></i>

                                            <div class="testi-personDetails flex">
                                                    <span class="name">Shubhangi Nemade</span>
                                                    <span class="job">Averta stratergy (Java Developer)</span>
                                            </div>
                                    </div>
                                    <div class="testi-content swiper-slide flex">
                                            <img src="assets/img/testimonials/testimonials-5.jpg" alt="" class="review-img">
                                            <p class="review-quote">In my life first time I learned lot of things with fun with collegues and teacher, At any moment I dont felt that the person who was teaching me was a teacher, It always feels me that they are my friend.</p>
                                            <i class='bx bxs-quote-alt-left quote-icon'></i>

                                            <div class="testi-personDetails flex">
                                                    <span class="name">Ujjwal Gadekar</span>
                                                    <span class="job">Micropro Software Solutions Pvt. Ltd.</span>
                                            </div>
                                    </div>
                                </div>
                                <div class="swiper-button-next swiper-navBtn"></div>
